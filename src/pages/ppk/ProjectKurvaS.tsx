...
export default function ProjectKurvaS() {
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-white rounded-xl shadow-md p-5 border border-hover hover:shadow-lg transition-all duration-300">
                ...
                <div className="space-y-3">
                  <div className="inline-flex items-center justify-center px-4 py-2 bg-hover text-secondary rounded-lg font-poppins-bold text-2xl border border-third">
                    {scheduleProgress}%
                  </div>
