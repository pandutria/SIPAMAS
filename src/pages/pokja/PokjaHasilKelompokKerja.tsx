    ...
    useEffect(() => {
        const filteringDataEntry = () => {
            const dataFilter = dataEntryPengadaan?.filter((item: DataEntryProps) => {
                ...
                return filterType && tahunFilter && metodeFilter && sumberDanaFilter && filterKelompok;
            });
        ...
        filteringDataEntry();
    }, [dataEntryPengadaan, tahun, metodePengadaan, sumberDana, metodePengadaanOptions, user]);
