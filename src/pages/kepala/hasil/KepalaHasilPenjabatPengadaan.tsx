...
export default function KepalaHasilPenjabatPengadaan() {
    ...
    const [namaPengguna, setNamaPengguna] = useState<any>(null);
    ...
    useEffect(() => {
        const filteringDataEntry = () => {
            const dataFilter = dataEntryPengadaan?.filter((item: DataEntryProps) => {
                ...
                const sumberDanaFilter = sumberDana
                    ...
                    : true;
                const namaPengggunaFilter = namaPengguna
                    ? item?.user_id == namaPengguna
                    : true;

                return filterType && tahunFilter && metodeFilter && sumberDanaFilter && namaPengggunaFilter;
            });
        ...
        filteringDataEntry();
    }, [dataEntryPengadaan, tahun, metodePengadaan, sumberDana, metodePengadaanOptions, namaPengguna]);
        ...
        <div>
            ...
            <div className="pt-24" data-aos="fade-up" data-aos-duration="1000">
                <TableHeaderReport
                    ...
                    onNamaPenggunaChange={setNamaPengguna}
                    namaPenggunaOptions={userOptions}
                    selectedNamaPengguna={namaPengguna}
                    isKepala={true}
                    onPrint={() => handlePrint()}
