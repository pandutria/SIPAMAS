...
export default function AdminDireksiRencanaAnggaran() {
    ...
    useEffect(() => {
        ...
        const fetchPreview = () => {
            if (selectPreview) {
                ...
                navigate(`/admin-direksi/rencana-anggaran/lihat/${id}`, {
                    state: {
                        reason: reason
                    }
                });
        ...
        <div>
                        ...
                        <button 
                            onClick={() => {
                                if (reason) {
                                    ...
                                    navigate(`/admin-direksi/rencana-anggaran/ubah/${selectRevisi?.id}`);
                                } else {
                                    SwalMessage({
                                        type: "error",
                                        title: "Gagal!",
            ...
            <div className="lg:pt-24 pt-26" data-aos="fade-up" data-aos-duration="1000">
                <TableHeader 
                    ...
                    showHapus={true}
                    onTambahClick={() => navigate("/admin-direksi/rencana-anggaran/tambah")}
